                    ...
                    <nav className="flex items-center justify-between h-16 sm:h-20 lg:h-24">
                        ...
                        <Link href="/" className="flex items-center gap-2 sm:gap-3 h-full group shrink-0 max-w-[75%] sm:max-w-[60%] lg:max-w-[40%]">
                            <Image
                                ...
                                width={100}
                                height={100}
                                className="h-24 sm:h-16 lg:h-32 w-auto object-contain shrink-0 transition-transform duration-300 group-hover:scale-105"
                                priority
                            />
                            <div className="flex flex-col items-start min-w-0">
                                <h1 className="text-base sm:text-lg lg:text-2xl font-heading font-bold text-foreground tracking-tight group-hover:text-primary transition-colors whitespace-nowrap">
                                    KBK
                                </h1>
