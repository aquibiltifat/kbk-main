...
const Header = () => {
    ...
    return (
        <header className="sticky top-0 pb-0 z-50 bg-background/95 backdrop-blur-md border-b border-border shadow-soft">
                ...
                <nav className="flex items-center justify-between h-32">
                    ...
                    <Link href="/" className="flex items-center gap-0 w-[40%] h-full group pr-4">
                        <Image
                            ...
                            width={100}
                            height={100}
                            className="h-49 w-auto object-contain flex-shrink-0 transition-transform duration-300 group-hover:scale-105 px-4"
                            priority
                        />
                        <div className="flex flex-col items-start z-10 -ml-6">
                            <h1 className="text-4xl lg:text-2xl font-heading font-bold text-foreground tracking-tight group-hover:text-primary transition-colors whitespace-nowrap">
                                KBK
                            </h1>
                            <p className="text-4xl lg:text-2xl font-heading font-bold text-foreground tracking-tight group-hover:text-primary transition-colors whitespace-nowrap">
